...
function get_max_value($tbl_nm = "",$maxfields = "",$where = "",$group_by = ""){
  ...
  public	function update_paid($Month)
  	{


  $sql = 'UPDATE MonthlyBills SET IsPaid = 0 WHERE IsPaid=1 AND Created_at LIKE "%-'.$Month.'-%" ';

  $query=$this->db->query($sql);

  $sql = 'UPDATE FutureBills SET IsPaid = 0 WHERE IsPaid=1 AND DueDate LIKE "%-'.$Month.'-%" ';
